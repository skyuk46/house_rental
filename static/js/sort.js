...
var price = document.querySelectorAll('#list_container .col-md-4 .price-a')
...
sortOption.onchange = function() {
    ...
    if (sortOption.value == "high") {
        for (var i = 0;i<prices.length;i++) {
            list.removeChild(prices[i].parentNode.parentNode.parentNode.parentNode.parentNode.parentNode)
            list.appendChild(prices[i].parentNode.parentNode.parentNode.parentNode.parentNode.parentNode)
        }
    }
